    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        switch(strings[0]) {
            ...
            case "list" -> {
                ...
                if(!unresolvedReportsPresent) commandSender.sendMessage("No unresolved bugs yet. Let'skeep it that way. ..");
                return true;
            }
            case "fix" -> {
            ...
            default -> {
                commandSender.sendMessage(ChatColor.RED + "/bug <report/resolve/listreports/fix>");
                return false;
            }
        }
